...
export const mockOrders: Order[] = [
  ...
  { orderId: 'OD004', totalAmount: 450000, orderStatus: OrderStatus.UNPAID, typeOfOrder: TypeOfOrder.SERVICE_ORDER, paidAmount: 0, remainingAmount: 450000, customerId: 'C002', customerName: 'Trần Văn Nam', createdAt: new Date(Date.now() - 172800000).toISOString() },
